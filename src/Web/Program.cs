...
builder.Services.AddScoped<ICompetitiveMatchRepository, CompetitiveMatchRepository>();
...
builder.Services.AddScoped<ICompetitiveMatchService, CompetitiveMatchService>();
